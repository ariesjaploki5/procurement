                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-show="!view_pr_form.purchase_order_id && view_pr_form.mode_id == 1 && current_user.role_id == 3" type="button" class="btn btn-success btn-sm" @click="store_pr_po(view_pr_form.purchase_request_id)">
                                Purchase Order 1
                            </button>
                            <button v-show="!view_pr_form.purchase_order_id && view_pr_form.mode_id == 4 && current_user.role_id == 3" type="button" class="btn btn-success btn-sm" @click="rfqPo_modal(rfq_po_form.purchase_request_id)">
                                Purchase Order 2
                            </button>
                        </div>
                    </div>
