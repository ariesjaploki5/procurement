    ...
    <div class="">
        ...
        <body>
            <div class="page-header">
                ...
                <div class="row">
                    ...
                    <div class="col-3 pr all">
                        <div class="row">
                            ...
                            <div class="col pr left right font-weight-bold text-center"><span>{{ pr.pr_id }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3 pr all">
                        <div class="row">
                            ...
                            <div class="col pr left right text-center font-weight-bold">
                                <small>{{ pr.created_at | myDate3 }}</small></div>
                ...
                <div class="row">
                    <div class="col-1 pr top right text-center font-weight-bold"><span>Item No.</span></div>
                    <div class="col-1 pr top right text-center font-weight-bold"><span>Qty</span></div>
                    <div class="col-1 pr top right text-center font-weight-bold"><span>Unit of Issue</span></div>
                    <div class="col-4 pr top right text-center font-weight-bold"><span>Item Description</span></div>
                    <div class="col-1 pr top right text-center font-weight-bold"><span>Stock No.</span></div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="page">
                                <div class="row" v-for="dpr in dmd_pr" :key="dpr.dpr_id">
                                    <div class="col-1 pr right text-center font-weight-bold">
                                        <span>{{ dpr.dmd_id }}</span>
                                    </div>
                                    <div class="col-1 pr right text-center font-weight-bold">
                                        <span>{{ dpr.request_quantity | numeral3 }}</span></div>
                                    <div class="col-1 pr right text-center font-weight-bold">
                                        <span>{{ dpr.unit_desc }}</span>
                                    </div>
                                    <div class="col-4 pr right text-center font-weight-bold ex1" id="ex1">
                                        <span>{{ dpr.dmddesc }}</span>
                                    </div>
                                    <div class="col-1 pr right text-center font-weight-bold"><span></span>
                                    </div>
                                    <div class="col-2 pr right text-center font-weight-bold">
                                        <span>{{ dpr.cost_price | currency2 }}</span></div>
                                    <div class="col-2 pr text-center font-weight-bold">
                                        <span>{{ dpr.total_amount | currency2 }}</span></div>
                                </div>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="page-footer">
                <div class="row">
                    <div class="col pr right text-center font-weight-bold"><span></span></div>
                    <div class="col pr right text-center font-weight-bold"><span></span></div>
                    <div class="col pr right text-center font-weight-bold"><span></span></div>
                    <div class="col-4 pr right text-center font-weight-bold"><span></span></div>
                    <div class="col pr right text-center font-weight-bold"><span></span></div>
                    <div class="col-2 pr right text-center font-weight-bold"><span></span></div>
                    <div class="col-2 pr text-center font-weight-bold" style="border-bottom:double">
                        <span>{{ pr.total_amount | currency2 }}</span></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col pr left top text-primary font-italic"><span>(For Procurement Management Office
                            only)</span></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-5 pr top left text-center font-weight-bold"><span>RAY P. SUANDING, MD, FPCP,
                            FPCCP</span></div>
                </div>
                <div class="row">
...
<script>
    export default {
        ...
        methods: {
            get_pr() {
                axios.get('../../api/purchase_request/' + this.$route.params.id).then(({
                    data
                }) => {
                    this.dmd_pr = data;
                }).catch(() => {
            ...
            get_pr_2() {
                axios.get('../../api/get_pr/' + this.$route.params.id).then(({
                    data
                }) => {
                    this.pr = data;
                }).catch(() => {
