    ...
    <div class="container" id="container">
                    ...
                    <div class="po col bottom">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="po all text-center font-weight-bold">BAGUIO GENERAL HOSPITAL AND MEDICAL
                                    CENTER</div>
                ...
                <div class="row po top bottom">
                    ...
                    <div class="col po top bottom right">
                        <div class="row">
                            ...
                            <div class="col po top left right font-weight-bold">
                                {{ purchase_order.created_at | myDate3 }}</div>
                            <div class="col-1 po all"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col po top">
                <span>GENTLEMEN: Please furnish this office the following articles subject to the terms and conditions
                ...
                <div class="row po top bottom">
                    ...
                    <div class="col po top bottom right">
                        <div class="row">
                            ...
                            <div class="col po top left right font-weight-bold"><span
                                    v-if="purchase_order.delivery_term">{{ purchase_order.delivery_term }} Calendar
                                    Days</span></div>
                            <div class="col-1 po all"></div>
                        </div>
                    </div>
                ...
                <div class="row po top bottom">
                    ...
                    <div class="col po top bottom right">
                        <div class="row">
                            ...
                            <div class="col po top left right font-weight-bold">{{ purchase_order.payment_term_desc }}
                            </div>
                            <div class="col-1 po all"></div>
                        </div>
                    </div>
        ...
        <div id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 po left right font-weight-bold font-italic">
                            <span v-if="purchase_order.amount">{{ purchase_order.amount | num_words }} Pesos Only
                                <span v-if="purchase_order.cent > 0">and {{ purchase_order.cent | num_words  }} centavos
                                    only</span>
                            </span>
                        </div>
                        <div class="col po font-weight-bold text-right">{{ purchase_order.total_amount | currency2 }}
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 po top bottom text-justify indent dheight">
                    <span>
                        Non-delivery of the above-mentioned item/s, partial, or completely delivery, within the
                        prescribed
                        delivery term shall have the effect of
                        cancellation of the Purchase Order and Subsequent orders. In case you will be allowed to deliver
                        beyond the delivery term, partial or completely
                        delivery, a penalty of one-tenth(1/10) of one percent (1%) for everyday of delay shall be
                        imposed.
                    </span>
                </div>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col po top left bottom">
                            <div class="row">
                                <div class="col-3 po all"></div>
                                <div class="col-9 po all font-weight-bold text-center mleft">RICARDO B. RUNEZ
                                    JR.,MD,FPCS,MHA,CESE</div>
                                <div class="col-1 po all"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row po top bottom">
                        ...
                        <div class="col po top bottom right">
                            <div class="row">
                                ...
                                <div class="col po top left right text-center">
                                    <small>{{ purchase_order.obrs_no }}</small>
                                </div>
                                <div class="col-1 po all"></div>
                            </div>
                        </div>
                    ...
                    <div class="row po top bottom">
                        ...
                        <div class="col po top bottom right">
                            <div class="row">
                                ...
                                <div class="col po top left right text-center">{{purchase_order.obrs_date | myDate3}}
                                </div>
                                <div class="col-1 po all"></div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="row po top bottom">
                        <div class="col po all">
                            <div class="row">
                                <div class="col-4 po all"></div>
                                <div class="col po top left right text-center font-weight-bold">CECILIA J. PUGONG, CPA
                                </div>
                                <div class="col-1 po all"></div>
                            </div>
                        </div>
                        <div class="col po top bottom right">
                            <div class="row">
                                ...
                                <div class="col po top left right text-right font-weight-bold">
                                    {{ purchase_order.amount | currency2 }}</div>
                                <div class="col-1 po all"></div>
                            </div>
                        </div>
                    </div>
