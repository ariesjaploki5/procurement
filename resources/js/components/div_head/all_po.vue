            ...
            <table class="table table-sm table-hover">
                ...
                <tbody class="table-bordered">
                    <tr v-for="po in pos" :key="po.purchase_order_id">
                        ...
                        <th width="7%">
                            <button type="button" class="btn btn-sm btn-success" v-if="po.last_status.current_status_id == 7" @click="cmps_rcv(po.purchase_order_id)">
                                <i class="fas fa-file-download"></i>
                            </button>
                            <button type="button" class="btn btn-sm btn-danger" v-if="po.last_status.current_status_id == 8" @click="cmps_rls(po.purchase_order_id)">
...
export default {
    ...
    methods:{
        ...
        cmps_rcv(id){
            axios.put('../../api/cmps_rcv_po/'+id).then(() => {
                toast.fire({
                    type: 'success',
                    title: 'PO Received'
                });
        ...
        cmps_rls(id){
            axios.put('../../api/cmps_rls_po/'+id).then(() => {
                toast.fire({
                    type: 'success',
                    title: 'PO Release'
                });
