                        ...
                        <tr v-for="pos in purchase_orders" :key="pos.purchase_order_id">
                            ...
                            <td>
                                ...
                                <div id="document_tracking" class="">
                                    <button type="button" v-show="pos.budget_rls && !pos.accntng_rcv" class="btn btn-sm btn-success" @click="accounting_rcv(pos.purchase_order_id)">Received From Budget</button>
                                    <button type="button" v-show="pos.accntng_rcv && !pos.accntng_rls" class="btn btn-sm btn-danger" @click="accounting_rls(pos.purchase_order_id)">Send To FMO</button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
