                                    ...
                                    <td>
                                        ...
                                        <div id="document_tracking" class="">
                                            <div v-show="current_user.role_id == 5">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.div_head_rcv_2" @click="div_head_rcv_2(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.div_head_rcv_2" @click="div_head_rls_2(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            <div v-show="current_user.role_id == 3">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.pmo_rcv_2" @click="pmo_rcv_2(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.pmo_rcv_2" @click="pmo_rls_2(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            <div v-show="current_user.role_id == 6">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.budget_rcv" @click="budget_rcv(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.budget_rcv" @click="budget_rls(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            ...
                                            <div v-show="current_user.role_id == 9">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.mcc_rcv" @click="mcc_rcv(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.mcc_rcv" @click="mcc_rls(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            <div v-show="current_user.role_id == 8">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.fmo_rcv" @click="fmo_rcv(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.fmo_rcv" @click="fmo_rls(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            <div v-show="current_user.role_id == 3">
                                                <button type="button" class="btn btn-sm btn-success" v-show="!pos.purchase_request.pmo_rcv_3" @click="pmo_rcv_3(pos.purchase_order_id)"><i class="fas fa-file-download"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.pmo_rcv_3" @click="pmo_rls_3(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                            <div v-show="current_user.role_id == 4">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" v-show="pos.purchase_request.mmo_rcv" @click="mmo_rls(pos.purchase_order_id)"><i class="fas fa-file-upload"></i></button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
